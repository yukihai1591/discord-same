...
export function mainThemeVariations(theme) {
    return {
        mainThemeDark: createMuiTheme(_.merge({}, theme, { palette: { type: 'dark' }, ...mustHaveThemeOptions })),
        mainThemeLight: createMuiTheme(_.merge({}, theme, { palette: { type: 'light' }, ...mustHaveThemeOptions }))
    }
}
